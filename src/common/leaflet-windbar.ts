...
class WindBarb extends L.Icon {
    ...
    public icon(options?): any {
        return new WindBarb(options)
    }
    ...
    _createBarbs(speed: any): any {
        ...
        if (fd === true) {
            ...
            path.setAttributeNS(null, 'stroke', '#1abc9c')
        ...
        if (bn !== 0) {
            ...
            if (b[50] > 0) {
                ...
                for (var i = 0; i < b[50]; i++) {
                    ...
                    path.setAttributeNS(null, 'stroke', '#1abc9c')
                    path.setAttributeNS(null, 'stroke-width', sw)
                    path.setAttributeNS(null, 'fill', '#1abc9c')
    ...
    createShadow(): any {
        let d, s, b
        ;(d = this.options.deg + 90), (s = this.options.speed), (b = this._createBarbs(s))
